...
\begin{document}
  ...
  Tikz is the most powerful and popular package for drawing geometry as well as general drawing.

  I suggest to use GeoGebra, a strong Web IDE to draw diagrams - \url{https://www.geogebra.org/classic#geometry}
